...
public class MyBigDecimal extends BigDecimal {
    ...
    public MyBigDecimal divide(int divisor, int decimalPlaces) {
        return new MyBigDecimal(round(decimalPlaces).divide(new BigDecimal(divisor), RoundingMode.HALF_UP));
    }
    ...
    public MyBigDecimal subtract(MyBigDecimal subtract) {
        return new MyBigDecimal(this.subtract((BigDecimal) subtract));
    }
    ...
    public MyBigDecimal round(int decimalPlaces) {
        return new MyBigDecimal(this.setScale(decimalPlaces, RoundingMode.HALF_UP));
    }
}
